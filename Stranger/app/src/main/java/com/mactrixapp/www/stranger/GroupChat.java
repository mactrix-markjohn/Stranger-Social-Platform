...
import com.mactrixapp.www.stranger.Adapters.GroupAdapter;
...
public class GroupChat extends AppCompatActivity
  ...
  //  private String strangerid;
    ...
    private SharedPref chatcountPref;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatstorage = FirebaseStorage.getInstance().getReference().child(getString(R.string.group));
        String key = currentUser.getUid().concat(groupid);// key to shared preference
        String keycount = currentUser.getUid().concat(groupid).concat(getString(R.string.group));
        chatcountPref = new SharedPref(this,keycount);// shared preference to store last chat list count number
        lastChatPref = new SharedPref(this,key);// shared preference to store last chat time, so as tp count unread chat
        ...
        groupReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (group != null) {
                    ...
                    try {
                        Glide.with(GroupChat.this).load(Uri.parse(group.getImageurl())).asBitmap().into(chatuserphoto);
                    } catch (Exception e) {
    ...
    private void receivemessage() {
        ...
        GroupAdapter groupAdapter = new GroupAdapter(GroupChat.this,chats);
        chatview.setAdapter(groupAdapter);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                runOnUiThread(() ->{
                   ...
                   groupAdapter.notifyDataSetChanged();
                    chatcountPref.setInt(chatview.getChildCount());
        ...
        new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    int pos = chatcountPref.getInt() -1;
    ...
    public void groupprofile(View view) {
        ...
        Intent intent = new Intent(this,GroupChatProfile.class);
            ...
            if(inputStream != null){
                ...
                Task<Uri> task = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(GroupChat.this, "Unable to send file, try again", Toast.LENGTH_SHORT).show();
                        DatabaseReference chatinput = chatReference.push();
                        chat.setChatid(chatinput.getKey());
                        chatinput.setValue(chat).addOnSuccessListener(vvv -> filetype = getString(R.string.chatfiletype));
