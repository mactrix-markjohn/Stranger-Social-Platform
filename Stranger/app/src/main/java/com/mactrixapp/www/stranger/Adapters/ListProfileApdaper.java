...
public class ListProfileApdaper extends BaseAdapter {
    ...
    public ListProfileApdaper(Context context , ArrayList<Post> postArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = inflater.inflate(R.layout.listprofilelayout,parent,false);
        }
