...
public class StrangerGroupAdapter extends RecyclerView.Adapter {
    ...
    public StrangerGroupAdapter(Context context, ArrayList<Chat> chats) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == CHATRIGHT) {
            ...
            return new StrangerGroupAdapter.ViewHolder(view);
            ...
            return new StrangerGroupAdapter.ViewHolderImage(view);
            ...
            return new StrangerGroupAdapter.ViewHolderVideo(view);
            ...
            return new StrangerGroupAdapter.ViewHolderAudio(view);
            ...
            return new StrangerGroupAdapter.ViewHolderFile(view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(type == CHATRIGHT) {
            bindview((StrangerGroupAdapter.ViewHolder)holder,chat);
            ...
            bindviewImage((StrangerGroupAdapter.ViewHolderImage)holder,chat);
            ...
            bindviewvideo((StrangerGroupAdapter.ViewHolderVideo)holder,chat);
            ...
            bindviewaudio((StrangerGroupAdapter.ViewHolderAudio)holder,chat);
            ...
            bindviewfiles((StrangerGroupAdapter.ViewHolderFile)holder,chat);
    ...
    public void bindview (StrangerGroupAdapter.ViewHolder holder, Chat chat){
    ...
    public void bindviewImage(StrangerGroupAdapter.ViewHolderImage holder,Chat chat){// Retrieving the date and time of the chat
        long time = chat.getDate();
        Date date = new Date(time);
        Date now = new Date();
        long today = now.getTime();
    ...
    public void bindviewvideo(StrangerGroupAdapter.ViewHolderVideo holder, Chat chat){// Retrieving the date and time of the chat
        long time = chat.getDate();
        Date date = new Date(time);
        Date now = new Date();
        long today = now.getTime();
    ...
    public void bindviewaudio(StrangerGroupAdapter.ViewHolderAudio holder, Chat chat){// Retrieving the date and time of the chat
        long time = chat.getDate();
        Date date = new Date(time);
        Date now = new Date();
        long today = now.getTime();
    ...
    public void bindviewfiles(StrangerGroupAdapter.ViewHolderFile holder, Chat chat){// Retrieving the date and time of the chat
        long time = chat.getDate();
        Date date = new Date(time);
        Date now = new Date();
        long today = now.getTime();
