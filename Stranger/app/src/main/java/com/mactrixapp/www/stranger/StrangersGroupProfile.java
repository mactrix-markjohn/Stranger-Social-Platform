...
public class StrangersGroupProfile extends AppCompatActivity
    ...
    private ImageView searchmembe;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_strangers_group_profile);
        ...
        searchmembe = (ImageView)findViewById(R.id.searchmember);
    ...
    public void setUpProfile(){
        ...
        groupReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (group != null) {
                    ...
                    try {
                        Glide.with(StrangersGroupProfile.this).load(Uri.parse(group.getImageurl())).asBitmap().into(groupphoto);
                    } catch (Exception e) {
        ...
        groupReference.child(getString(R.string.request)).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                GroupRequestAdapter requestAdapter = new GroupRequestAdapter(StrangersGroupProfile.this,requestArray);
        ...
        groupReference.child(getString(R.string.admin)).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                GroupAdminAdapter adminAdapter = new GroupAdminAdapter(StrangersGroupProfile.this,adminArray);
        ...
        groupReference.child(getString(R.string.members)).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                GroupMemberAdapter memberAdapter = new GroupMemberAdapter(StrangersGroupProfile.this,memberArray);
    ...
    public void handleListItemClick(){
        ...
        groupjoinlist.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (adminIdArray.contains(currentuser.getUid())) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(StrangersGroupProfile.this);
    ...
    public void showaddDialog(){
        ...
        FirebaseDatabase.getInstance().getReference().child(getString(R.string.user)).child(currentuser.getUid()).child(getString(R.string.friends)).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                GroupMemberAdapter memberAdapter = new GroupMemberAdapter(StrangersGroupProfile.this,friendarray);
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                groupReference.child(getString(R.string.members)).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        GroupMemberAdapter memberAdapter = new GroupMemberAdapter(StrangersGroupProfile.this,searchuser);
                        addlist.setAdapter(memberAdapter);
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == CHANGE_GROUP_PHOTO) {
                ...
                if (uri != null) {
                    ...
                    changephoto(uri,getString(R.string.strangersgroup));
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.strangers_group_profile, menu);
        return true;
    }
