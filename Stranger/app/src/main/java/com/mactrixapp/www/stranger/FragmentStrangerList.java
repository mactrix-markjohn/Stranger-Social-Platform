...
import com.mactrixapp.www.stranger.Adapters.StrangerListAdapter;
import com.mactrixapp.www.stranger.Model.User;

import java.util.ArrayList;

public class FragmentStrangerList extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_strangers_list,container,false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        strangerReference = userReference.child(context.getString(R.string.strangers));
        ...
        if(users.isEmpty()){
            ...
            strangerReference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                        ...
                        if(user != null){
                            ...
                            if(!isStrangerContain(users,user)){
                                users.add(user);
                    ...
                    StrangerListAdapter adapter = new StrangerListAdapter(context, users);
    ...
    public boolean isStrangerContain(ArrayList<User> userlist, User userinst){
