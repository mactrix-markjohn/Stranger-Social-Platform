...
public class GroupAdapter extends RecyclerView.Adapter {
    ...
    public GroupAdapter(Context context, ArrayList<Chat> chats) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == CHATRIGHT) {
            View view = inflater.inflate(R.layout.groupsenderright, parent, false);
            return new GroupAdapter.ViewHolder(view);

        }else if (viewType == CHATLEFT){
            View view = inflater.inflate(R.layout.grouprecieverleft, parent, false);
            return new GroupAdapter.ViewHolder(view);
        }else if(viewType == CHATRIGHTIMAGE) {

            //right image
            View view = inflater.inflate(R.layout.groupsenderrightimage, parent, false);
            return new GroupAdapter.ViewHolderImage(view);

        }else if(viewType == CHATLEFTIMAGE){
            View view = inflater.inflate(R.layout.grouprecieverleftimage, parent, false);
            return new GroupAdapter.ViewHolderImage(view);

        }else if(viewType == CHATRIGHTVIDEO){

            View view = inflater.inflate(R.layout.groupsenderrightvideo, parent, false);
            return new GroupAdapter.ViewHolderVideo(view);

        }else if(viewType == CHATLEFTVIDEO){
            View view = inflater.inflate(R.layout.grouprecieverleftvideo, parent, false);
            return new GroupAdapter.ViewHolderVideo(view);

        }else if(viewType == CHATRIGHTAUDIO){

            View view = inflater.inflate(R.layout.groupsenderrightaudio, parent, false);
            return new GroupAdapter.ViewHolderAudio(view);

        }else if(viewType ==CHATLEFTAUDIO){

            View view = inflater.inflate(R.layout.grouprecieverleftaudio, parent, false);
            return new GroupAdapter.ViewHolderAudio(view);

        }else if(viewType ==CHATRIGHTFILES){

            View view = inflater.inflate(R.layout.groupsenderrightfiles, parent, false);
            return new GroupAdapter.ViewHolderFile(view);


        }else{

            View view = inflater.inflate(R.layout.grouprecieverleftfiles, parent, false);
            return new GroupAdapter.ViewHolderFile(view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(type == CHATRIGHT) {
            bindview((GroupAdapter.ViewHolder)holder,chat);
            ...
            bindviewImage((GroupAdapter.ViewHolderImage)holder,chat);
            ...
            bindviewvideo((GroupAdapter.ViewHolderVideo)holder,chat);
            ...
            bindviewaudio((GroupAdapter.ViewHolderAudio)holder,chat);
            ...
            bindviewfiles((GroupAdapter.ViewHolderFile)holder,chat);
    ...
    public void bindview (GroupAdapter.ViewHolder holder, Chat chat){
        ...
        FirebaseDatabase.getInstance().getReference().child(context.getString(R.string.user)).child(chat.getSenderid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                User user = dataSnapshot.getValue(User.class);
                if(user != null){
                    holder.chatstatus.setText(user.getUsername());
    ...
    public void bindviewImage(GroupAdapter.ViewHolderImage holder,Chat chat){// Retrieving the date and time of the chat
        long time = chat.getDate();
        Date date = new Date(time);
        Date now = new Date();
        long today = now.getTime();
    ...
    public void bindviewvideo(GroupAdapter.ViewHolderVideo holder, Chat chat){// Retrieving the date and time of the chat
        long time = chat.getDate();
        Date date = new Date(time);
        Date now = new Date();
        long today = now.getTime();
    ...
    public void bindviewaudio(GroupAdapter.ViewHolderAudio holder, Chat chat){// Retrieving the date and time of the chat
        long time = chat.getDate();
        Date date = new Date(time);
        Date now = new Date();
        long today = now.getTime();
    ...
    public void bindviewfiles(GroupAdapter.ViewHolderFile holder, Chat chat){// Retrieving the date and time of the chat
        long time = chat.getDate();
        Date date = new Date(time);
        Date now = new Date();
        long today = now.getTime();
